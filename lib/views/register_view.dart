                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () async{
                          ...
                          try{
                            UserCredential credential = await instance.createUserWithEmailAndPassword(email:'${email.text}',password:'${password.text}');
                        ...
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all(viewModel.clrv4),
